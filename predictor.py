...
driver_dict = pickle.load(open('C:/Users/Dell/Documents/DBDA/PROJECT/Main_File/dictionary/driver_dict','rb'))
constructor_dict = pickle.load(open('C:/Users/Dell/Documents/DBDA/PROJECT/Main_File/dictionary/constructor_dict','rb'))
clf = pickle.load(open('C:/Users/Dell/Documents/DBDA/PROJECT/Main_File/raoforest.pkl','rb'))

data = pd.read_csv("C:/Users/Dell/Documents/DBDA/PROJECT/Main_File/cleaned_data.csv")
